...
DEFAULT_LOGGER_FLAG_FILE_NAME : DefaultLoggerFlag : 1 << 2
DEFAULT_LOGGER_FLAG_LINE      : DefaultLoggerFlag : 1 << 3
DEFAULT_LOGGER_FLAG_FUNCTION  : DefaultLoggerFlag : 1 << 4
DEFAULT_LOGGER_FLAG_THREAD_ID : DefaultLoggerFlag : 1 << 5
