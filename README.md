...
repository if you intend to build some of the projects.

```bash
$ git clone --recursive https://github.com/Maceris/Hemera.git
```

If you clone without using `--recursive`, (or to update the source tree after a new submodule has been added),
you can run this command to update dependencies:
```bash
